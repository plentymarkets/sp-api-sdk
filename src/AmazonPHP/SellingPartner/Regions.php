...
final class Regions
{
    ...
    public const EUROPE_HOST = 'sandbox.sellingpartnerapi-eu.amazon.com';

    public const EUROPE_URL = 'https://' . self::EUROPE_HOST;

    public const FAR_EAST = 'us-west-2';

    public const FAR_EAST_HOST = 'sandbox.sellingpartnerapi-fe.amazon.com';

    public const FAR_EAST_URL = 'https://' . self::FAR_EAST_HOST;

    public const NORTH_AMERICA = 'us-east-1';

    public const NORTH_AMERICA_HOST = 'sandbox.sellingpartnerapi-na.amazon.com';

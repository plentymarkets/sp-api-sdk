...
class ConfigurationExt
{
    ...
    public function __construct(
        ...
        $this->lwaClientID = $secrets['clientId'];
        $this->lwaClientSecret = $secrets['clientSecret'];
    ...
    public static function forIAMRole_(string $clientId, string $clientSecret, Credentials $credentials) : self
    {

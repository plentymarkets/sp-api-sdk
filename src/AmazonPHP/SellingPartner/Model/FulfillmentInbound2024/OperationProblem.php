...
class OperationProblem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setCode($code): static
    {
        if ((mb_strlen($code) > 256)) {
            throw new \InvalidArgumentException(
                'invalid length for $code when calling OperationProblem., must be smaller than or equal to 256.'
            );
        }
        if ((mb_strlen($code) < 1)) {
            throw new \InvalidArgumentException(
                'invalid length for $code when calling OperationProblem., must be bigger than or equal to 1.'
            );
        }
    ...
    public function setDetails($details): static
    {
        if (!is_null($details) && (mb_strlen($details) > 8192)) {
            throw new \InvalidArgumentException(
                'invalid length for $details when calling OperationProblem., must be smaller than or equal to 8192.'
            );
        }
        if (!is_null($details) && (mb_strlen($details) < 0)) {
            throw new \InvalidArgumentException(
                'invalid length for $details when calling OperationProblem., must be bigger than or equal to 0.'
            );
        }
    ...
    public function setMessage($message): static
    {
        if ((mb_strlen($message) > 2048)) {
            throw new \InvalidArgumentException(
                'invalid length for $message when calling OperationProblem., must be smaller than or equal to 2048.'
            );
        }
        if ((mb_strlen($message) < 1)) {
            throw new \InvalidArgumentException(
                'invalid length for $message when calling OperationProblem., must be bigger than or equal to 1.'
            );
        }
    ...
    public function setSeverity($severity): static
    {
        if ((mb_strlen($severity) > 1024)) {
            throw new \InvalidArgumentException(
                'invalid length for $severity when calling OperationProblem., must be smaller than or equal to 1024.'
            );
        }
        if ((mb_strlen($severity) < 1)) {
            throw new \InvalidArgumentException(
                'invalid length for $severity when calling OperationProblem., must be bigger than or equal to 1.'
            );
        }

    ...
    public function setNextToken($next_token)
    {
        if (!is_null($next_token) && (mb_strlen($next_token) > 1024)) {
            throw new \InvalidArgumentException(
                'invalid length for $next_token when calling Pagination., must be smaller than or equal to 1024.'
            );
        }
        if (!is_null($next_token) && (mb_strlen($next_token) < 1)) {
            throw new \InvalidArgumentException(
                'invalid length for $next_token when calling Pagination., must be bigger than or equal to 1.'
            );
        }

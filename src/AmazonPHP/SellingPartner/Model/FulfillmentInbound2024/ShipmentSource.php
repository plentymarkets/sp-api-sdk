    ...
    public function setSourceType($source_type): static
    {
        if ((mb_strlen($source_type) > 1024)) {
            throw new \InvalidArgumentException(
                'invalid length for $source_type when calling ShipmentSource., must be smaller than or equal to 1024.'
            );
        }
        if ((mb_strlen($source_type) < 1)) {
            throw new \InvalidArgumentException(
                'invalid length for $source_type when calling ShipmentSource., must be bigger than or equal to 1.'
            );
        }

...
class Pallet implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setPackageId($package_id)
    {
        if ((mb_strlen($package_id) > 38)) {
            throw new \InvalidArgumentException(
                'invalid length for $package_id when calling Pallet., must be smaller than or equal to 38.'
            );
        }
        if ((mb_strlen($package_id) < 38)) {
            throw new \InvalidArgumentException(
                'invalid length for $package_id when calling Pallet., must be bigger than or equal to 38.'
            );
        }
        if ((!preg_match("/^[a-zA-Z0-9-]*$/", $package_id))) {
            throw new \InvalidArgumentException(
                "invalid value for $package_id when calling Pallet., must conform to the pattern /^[a-zA-Z0-9-]*$/."
            );
        }
    ...
    public function setQuantity($quantity)
    {
        if (!is_null($quantity) && ($quantity > 10000)) {
            throw new \InvalidArgumentException(
                'invalid value for $quantity when calling Pallet., must be smaller than or equal to 10000.'
            );
        }
        if (!is_null($quantity) && ($quantity < 1)) {
            throw new \InvalidArgumentException(
                'invalid value for $quantity when calling Pallet., must be bigger than or equal to 1.'
            );
        }
     ...
     * Sets stackability
     *
     * @param \Plenty\AmazonPHP\SellingPartner\Model\FulfillmentInbound2024\Stackability|null $stackability stackability
     *
     * @return self
     */

...
class GeneratePlacementOptionsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @return CustomPlacementInput[]|null
     */
     ...
     *
     * @param CustomPlacementInput[]|null $custom_placement Custom placement options to be added to the plan.
     *
     * @return self
     */
    public function setCustomPlacement($custom_placement): static
    {

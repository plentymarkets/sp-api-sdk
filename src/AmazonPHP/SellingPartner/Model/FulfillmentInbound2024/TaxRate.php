...
class TaxRate implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @return self
     */
    public function setCessRate($cess_rate): static
    {
     ...
     * @return self
     */
    public function setGstRate($gst_rate): static
    {
     ...
     * @return self
     */
    public function setTaxType($tax_type): static
    {
        if (!is_null($tax_type) && (mb_strlen($tax_type) > 1024)) {
            throw new \InvalidArgumentException(
                'invalid length for $tax_type when calling TaxRate., must be smaller than or equal to 1024.'
            );
        }
        if (!is_null($tax_type) && (mb_strlen($tax_type) < 1)) {
            throw new \InvalidArgumentException(
                'invalid length for $tax_type when calling TaxRate., must be bigger than or equal to 1.'
            );
        }

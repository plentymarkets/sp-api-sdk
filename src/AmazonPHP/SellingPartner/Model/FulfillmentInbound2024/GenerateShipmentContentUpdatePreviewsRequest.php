...
class GenerateShipmentContentUpdatePreviewsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setBoxes($boxes)
    {
        if ((count($boxes) > 5000)) {
            throw new \InvalidArgumentException(
                'invalid value for $boxes when calling GenerateShipmentContentUpdatePreviewsRequest., number of items must be less than or equal to 5000.'
            );
        }
        if ((count($boxes) < 1)) {
            throw new \InvalidArgumentException(
                'invalid length for $boxes when calling GenerateShipmentContentUpdatePreviewsRequest., number of items must be greater than or equal to 1.'
            );
        }
    ...
    public function setItems($items)
    {
        if ((count($items) > 2000)) {
            throw new \InvalidArgumentException(
                'invalid value for $items when calling GenerateShipmentContentUpdatePreviewsRequest., number of items must be less than or equal to 2000.'
            );
        }
        if ((count($items) < 1)) {
            throw new \InvalidArgumentException(
                'invalid length for $items when calling GenerateShipmentContentUpdatePreviewsRequest., number of items must be greater than or equal to 1.'
            );
        }

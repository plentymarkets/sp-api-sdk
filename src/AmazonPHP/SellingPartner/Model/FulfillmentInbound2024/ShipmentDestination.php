...
class ShipmentDestination implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets address
     *
     * @param \Plenty\AmazonPHP\SellingPartner\Model\FulfillmentInbound2024\Address|null $address address
     *
     * @return self
     */
    ...
    public function setDestinationType($destination_type): static
    {
        if ((mb_strlen($destination_type) > 1024)) {
            throw new \InvalidArgumentException(
                'invalid length for $destination_type when calling ShipmentDestination., must be smaller than or equal to 1024.'
            );
        }
        if ((mb_strlen($destination_type) < 1)) {
            throw new \InvalidArgumentException(
                'invalid length for $destination_type when calling ShipmentDestination., must be bigger than or equal to 1.'
            );
        }
    ...
    public function setWarehouseId($warehouse_id): static
    {
        if (!is_null($warehouse_id) && (mb_strlen($warehouse_id) > 1024)) {
            throw new \InvalidArgumentException(
                'invalid length for $warehouse_id when calling ShipmentDestination., must be smaller than or equal to 1024.'
            );
        }
        if (!is_null($warehouse_id) && (mb_strlen($warehouse_id) < 1)) {
            throw new \InvalidArgumentException(
                'invalid length for $warehouse_id when calling ShipmentDestination., must be bigger than or equal to 1.'
            );
        }

...
class BoxUpdateInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!is_null($this->container['package_id']) && !preg_match(
                "/^[a-zA-Z0-9-]*$/",
                $this->container['package_id']
            )) {
    ...
    public function setPackageId($package_id): static
    {
        if (!is_null($package_id) && (mb_strlen($package_id) > 38)) {
            throw new \InvalidArgumentException(
                'invalid length for $package_id when calling BoxUpdateInput., must be smaller than or equal to 38.'
            );
        }
        if (!is_null($package_id) && (mb_strlen($package_id) < 38)) {
            throw new \InvalidArgumentException(
                'invalid length for $package_id when calling BoxUpdateInput., must be bigger than or equal to 38.'
            );
        }
        if (!is_null($package_id) && (!preg_match("/^[a-zA-Z0-9-]*$/", $package_id))) {
            throw new \InvalidArgumentException(
                "invalid value for $package_id when calling BoxUpdateInput., must conform to the pattern /^[a-zA-Z0-9-]*$/."
            );
        }
    ...
    public function setQuantity($quantity): static
    {
        if (($quantity > 10000)) {
            throw new \InvalidArgumentException(
                'invalid value for $quantity when calling BoxUpdateInput., must be smaller than or equal to 10000.'
            );
        }
        if (($quantity < 1)) {
            throw new \InvalidArgumentException(
                'invalid value for $quantity when calling BoxUpdateInput., must be bigger than or equal to 1.'
            );
        }

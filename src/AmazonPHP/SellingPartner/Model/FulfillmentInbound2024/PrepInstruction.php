...
class PrepInstruction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setPrepOwner($prep_owner): static
    {
        if (!is_null($prep_owner) && (mb_strlen($prep_owner) > 1024)) {
            throw new \InvalidArgumentException(
                'invalid length for $prep_owner when calling PrepInstruction., must be smaller than or equal to 1024.'
            );
        }
        if (!is_null($prep_owner) && (mb_strlen($prep_owner) < 1)) {
            throw new \InvalidArgumentException(
                'invalid length for $prep_owner when calling PrepInstruction., must be bigger than or equal to 1.'
            );
        }
     ...
     * @return self
     */
    public function setPrepType($prep_type): static
    {
        if (!is_null($prep_type) && (mb_strlen($prep_type) > 1024)) {
            throw new \InvalidArgumentException(
                'invalid length for $prep_type when calling PrepInstruction., must be smaller than or equal to 1024.'
            );
        }
        if (!is_null($prep_type) && (mb_strlen($prep_type) < 1)) {
            throw new \InvalidArgumentException(
                'invalid length for $prep_type when calling PrepInstruction., must be bigger than or equal to 1.'
            );
        }

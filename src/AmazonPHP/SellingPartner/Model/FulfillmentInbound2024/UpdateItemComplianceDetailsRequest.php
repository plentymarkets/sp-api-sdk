...
class UpdateItemComplianceDetailsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setMsku($msku): static
    {
        if ((mb_strlen($msku) > 40)) {
            throw new \InvalidArgumentException(
                'invalid length for $msku when calling UpdateItemComplianceDetailsRequest., must be smaller than or equal to 40.'
            );
        }
        if ((mb_strlen($msku) < 1)) {
            throw new \InvalidArgumentException(
                'invalid length for $msku when calling UpdateItemComplianceDetailsRequest., must be bigger than or equal to 1.'
            );
        }
     ...
     * Gets tax_details
     *
     * @return \Plenty\AmazonPHP\SellingPartner\Model\FulfillmentInbound2024\TaxDetails
     */
     ...
     * Sets tax_details
     *
     * @param \Plenty\AmazonPHP\SellingPartner\Model\FulfillmentInbound2024\TaxDetails $tax_details tax_details
     *
     * @return self
     */
    public function setTaxDetails($tax_details): static
    {
